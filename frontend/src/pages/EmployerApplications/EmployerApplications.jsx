              ...
              <div key={app.id} className="app-card">
                <div className="app-user-info">
                  <div className="app-avatar">
                    {resume.avatar ? <img src={`${BASE_URL}/uploads/${resume.avatar}`} alt="avatar" /> : <User size={24} />}
                  </div>
                  <div>
            ...
            <div className="modal-body resume-modal-body">
              <div className="resume-header">
                <div className="resume-avatar-large">
                  {selectedResume.avatar ? <img src={`${BASE_URL}/uploads/${selectedResume.avatar}`} alt="Avatar" /> : <User size={48} />}
                </div>
                <div>
